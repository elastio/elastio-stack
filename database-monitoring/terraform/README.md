...
| <a name="input_image"></a> [image](#input_image)                                        | Agent image. The default is the agent release this module version was tested with. Pin a version; :latest moves.                                                                                                                                                              | `string`       | `"public.ecr.aws/elastio/elastio-database-monitoring-agent:0.1.4"` |    no    |
